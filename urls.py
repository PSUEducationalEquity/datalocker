...
urlpatterns = patterns('',
    ...
    url(r'^(?P<locker_id>[0-9]+)/modify$',
        views.modify_locker,
        name='modify_locker'),
    url(r'^(?P<locker_id>[0-9]+)/submissions/(?P<pk>[0-9]+)/delete$',
        views.delete_submission,
        name='delete_submission'),
    url(r'^(?P<locker_id>[0-9]+)/submissions/(?P<pk>[0-9]+)/undelete$',
    ...
    # url(r'^(?P<locker_id>[0-9]+)/submissions/(?P<submission_id>[0-9]+)/discussion/addReply$',
    #     views.add_reply,
    #     name='add_reply',
    #     ),
